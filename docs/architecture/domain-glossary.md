...
| Term | Definition |
|------|------------|
| **Prompt** | A coding task/specification to be answered by a model — content, language, difficulty, tags. The unit work is evaluated *against*. |
...
| **Rubric** | A versioned set of weighted criteria defining *how* a submission is scored (e.g. correctness, readability, efficiency). |
